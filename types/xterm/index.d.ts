 ...
 */
declare type RendererType = 'dom' | 'canvas';

/**
 * An object containing start up options for the terminal.
 */
declare interface ITerminalOptions {
	/**
 ...
 */
declare interface ILinkMatcherOptions {
	/**
...
declare interface IMarker extends IDisposable {
	readonly id: number;
	readonly isDisposed: boolean;
	readonly line: number;
}

declare interface ILocalizableStrings {
	blankLine: string;
	promptLabel: string;
 ...
 */
declare class Terminal implements IEventEmitter, IDisposable {
	/**
 ...
 */
declare interface ITerminalAddon extends IDisposable {
	/**
