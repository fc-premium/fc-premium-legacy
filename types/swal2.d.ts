...
declare type SweetAlertType = 'success' | 'error' | 'warning' | 'info' | 'question';

declare interface SweetAlertResult {
	value?: any;
...
declare type SweetAlertArrayOptions = [string] | [string, string] | [string, string, string];

declare interface SweetAlertOptions {
	/**
